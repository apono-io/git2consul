...
Branch.prototype.timedHandleRefChange = function(target_ref, cb) {
  var start = process.hrtime();
  this.handleRefChange(target_ref, cb);
  ...
  this.pull(function(err, output) {
    ...
    var handle_successful_pull = function() {
      ...
      if (this_obj.pending_ref_change) {
        this_obj.timedHandleRefChange(this_obj.pending_ref_change, function(err) {
