...
exports.handleRefChange = function(branch, cb) {
  ...
  handleRefChange(branch, cb)
  end = process.hrtime(start)
  delta = (end[0] * 1000) + (end[1] / 1000000)
  logger.debug('consul.handleRefChange execution time (hr): %dms', delta)
  dogstatsd.timing('git2consul.timing', delta, ['consul:update'])
}

handleRefChange = function(branch, cb) {
